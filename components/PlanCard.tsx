...
export function PlanCard({ id, title, description, duration }: PlanCardProps) {
  return (
    <article className="rounded-xl2 border border-charcoal/10 bg-white/70 p-6 shadow-soft">
      ...
      <div className="mt-5 flex items-center justify-between">
        ...
        <form action={selectPlanAction}>
          ...
          <button
            type="submit"
            className="rounded-full bg-charcoal px-4 py-2 text-sm text-white transition hover:bg-charcoal/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold"
